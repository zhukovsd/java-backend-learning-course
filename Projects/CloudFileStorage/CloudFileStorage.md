...
- Веб - upload и download файлов, заголовки HTTP запросов, cookies, cессии
- HTML/CSS
...
- Заголовок
  ...
  <!--Возможно стоит добавить страницу Welcome для отработки разделения страниц на те, что требует авторизации и на те, что не требуют-->
...
### Страница поиска файлов и папок
...
Неавторизованные пользователя не имеют доступа к данной странице, приложение должно редиректить их на главную страницу.
