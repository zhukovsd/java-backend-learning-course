...
- Готовый проект можете отправить мне на ревью - [https://t.me/zhukovsd](https://t.me/zhukovsd)
  - **[Обновление от 19 апреля 2023]** - целевое количество ревью проекта "Симуляция" на Java и Python накоплено, новые реализации на Java и Python к видео ревью не принимаются, на других языках принимаются. В любом случае призываю отправлять законченные проекты в [чат](https://t.me/zhukovsd_it_chat), по возможности делаю текстовые ревью. Подробности - [https://t.me/zhukovsd_it_mentor/57](https://t.me/zhukovsd_it_mentor/57) 
