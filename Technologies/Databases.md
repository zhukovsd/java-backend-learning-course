...
Документ посвящен знаниям по базам данных, необходимых для реализации проектов.
...
- Интерактиные задачи для практики с SQL, например https://app.codesignal.com/ (раздел Arcade - Databases)
