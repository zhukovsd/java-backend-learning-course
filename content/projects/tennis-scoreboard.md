...
В рамках [учебной подписки](https://zhukovsd.it/services/student-subscription/) доступна эталонная реализация на данный проект:
- Эталонная реализация по шагам (8 шагов, плюс)
- Разобранные темы:
  - Gradle
  - Spring MVC
  - Работа с БД - Hibernate, JPA
  - Lombok, MapStruct
  - Разработка бизнес логики подсчёта очков матча в рамках богатой доменной модели
  - Ручные тесты для REST API эндпоинтов
  - Интеграция фронтенда
  - Юнит тесты бизнес логики
  - Деплой - сборка war артефакта, установка Postgres, Tomcat
