...
- Практика:
  - Проект #6 ["Планировщик задач"](../projects/task-tracker.md) - разработка проекта в миросервисном стиле (4 сервиса на Spring Boot), кросс-сервисное общение через брокер сообщений Kafka
